...
//                        lessons.add(new Lesson(++lessonIdCounter, unit, schoolClassB));
    ...
    private static List<Room> generateRooms() {
        return List.of(
                new Room("101", RoomType.NORMAL),
                new Room("102", RoomType.NORMAL),
                new Room("103", RoomType.NORMAL),
                new Room("104", RoomType.NORMAL),
                new Room("105", RoomType.NORMAL),
                new Room("106", RoomType.NORMAL),
                new Room("107", RoomType.NORMAL),
                new Room("108", RoomType.NORMAL),
                new Room("109", RoomType.NORMAL),
                new Room("110", RoomType.NORMAL),
                new Room("111", RoomType.NORMAL),
                new Room("112", RoomType.NORMAL),
                new Room("113", RoomType.NORMAL),
                new Room("114", RoomType.NORMAL),
                new Room("115", RoomType.NORMAL),
                new Room("116", RoomType.NORMAL),
                new Room("117", RoomType.NORMAL),
                new Room("118", RoomType.NORMAL),
                new Room("119", RoomType.NORMAL),
                new Room("120", RoomType.NORMAL),
                new Room("121", RoomType.NORMAL),
                new Room("SCI_1", RoomType.CHEMISTRY_LAB),
                new Room("SCI_2", RoomType.CHEMISTRY_LAB),
                new Room("SCI_3", RoomType.PHYSICS_LAB),
                new Room("SCI_4", RoomType.PHYSICS_LAB),
                new Room("GYM_1", RoomType.GYM),
                new Room("GYM_2", RoomType.GYM),
                new Room("COMP_1", RoomType.COMPUTER_LAB),
                new Room("COMP_2", RoomType.COMPUTER_LAB),
                new Room("MUS_1", RoomType.MUSIC),
                new Room("MUS_2", RoomType.MUSIC)
        );
    }
